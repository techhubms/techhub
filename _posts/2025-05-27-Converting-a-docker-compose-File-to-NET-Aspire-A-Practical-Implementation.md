...
tags_normalized: ["net aspire", "net core", "app modeling", "aspire", "aspire app host", "ci slash cd", "coding", "containerization", "distributed application", "docker", "docker compose", "iac", "jetbrains rider", "listmonk", "nuget packages", "postgresql", "posts"]
---
