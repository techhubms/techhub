...
resource keyVault 'Microsoft.KeyVault/vaults@2024-04-01-preview' = {
  ...
  properties: {
    ...
    // Public access is only needed for admin IP allowlisting — Container Apps reach Key Vault
...
// Private endpoint — gives Container Apps a private IP path to Key Vault, removing the need
