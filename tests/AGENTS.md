...
**Singleton Services** (see `src/TechHub.Api/Program.cs`): `StartupStateService`, `ISqlDialect`/`PostgresDialect`, `IDbConnectionFactory`/`PostgresConnectionFactory`, `TimeProvider`
