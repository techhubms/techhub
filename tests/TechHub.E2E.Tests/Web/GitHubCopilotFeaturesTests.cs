...
public class GitHubCopilotFeaturesTests : IAsyncLifetime
{
    private readonly PlaywrightCollectionFixture _fixture;

    public GitHubCopilotFeaturesTests(PlaywrightCollectionFixture fixture)
    {
    ...
    public async Task GitHubCopilotFeatures_TierCards_ShouldBe_VisuallyDistinct()
    {
        ...
        // Verify grid has proper styling (check computed styles)
