...
public abstract class BaseContentRepositoryTests : IDisposable
{
    ...
    #region SearchAsync Tests - Collection Filtering

    /// <summary>
    /// Test: SearchAsync filters content by collection name
    ...
    /// <summary>
    /// Test: SearchAsync with no filters returns all content
    ...
    /// <summary>
    /// Test: SearchAsync with no sections returns all content
