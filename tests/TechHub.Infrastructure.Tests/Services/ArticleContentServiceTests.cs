...
/// Tests verify HTML content extraction for non-YouTube articles.
/// YouTube items are returned unchanged (transcripts are provided manually only).
/// </summary>
public class ArticleContentServiceTests
{
    ...
    [Fact]
    public async Task EnrichWithContentAsync_YouTubeItem_ReturnsUnchanged()
    {
        // YouTube items are not enriched — transcripts are provided manually only.
    ...
    [Fact]
    public async Task EnrichWithContentAsync_YouTubeShortUrl_ReturnsUnchanged()
    {
