...
![PAT creation](http://spindev.net/post/be-careful-with-repo-scope/pat-creation.png)
...
![repo scope](http://spindev.net/post/be-careful-with-repo-scope/repo-scope.png)
...
![repo scope docs](http://spindev.net/post/be-careful-with-repo-scope/repo-scope-docs.png)

Well, this is some kind of misleading, isn’t it? You have the `admin:org` scope for exactly this scenarios:

![org admin scope docs](http://spindev.net/post/be-careful-with-repo-scope/org-admin-scope-docs.png)
