...
- Reduce our average [INP](https://developer.mozilla.org/en-US/docs/Glossary/Interaction_to_next_paint) and significantly improve our p95 and p99 measurements
...
In v1, each diff line was expensive to render. In unified view, a single line required roughly 10 DOM elements; in split view, closer to 15. That’s before syntax highlighting, which adds many more `` tags and drives the DOM count even higher.
...
## 
 ...
 ![Luke Ghenco](https://avatars.githubusercontent.com/u/15013243?v=4&s=200)
 Senor Software Engineer

	

 
 ![Adam Shwert](https://avatars.githubusercontent.com/u/247706?v=4&s=200)
