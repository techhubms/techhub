...
test.describe('RSS Feeds', () => {
  ...
  const rssFeeds = [
    ...
    { name: 'AI', url: '/ai.xml', section: 'ai' },
    { name: 'GitHub Copilot', url: '/github-copilot.xml', section: 'github-copilot' },
    { name: 'ML', url: '/ml.xml', section: 'ml' },
    { name: 'Azure', url: '/azure.xml', section: 'azure' },
    { name: 'Coding', url: '/coding.xml', section: 'coding' },
    { name: 'DevOps', url: '/devops.xml', section: 'devops' },
    { name: 'Security', url: '/security.xml', section: 'security' },
    { name: 'Roundups', url: '/roundups.xml', section: 'roundups' }
  ];
  ...
  test('should have RSS feed links in footer', async ({ page }) => {
    ...
    const footerRssLink = page.locator('footer a[href="/feed.xml"]');
