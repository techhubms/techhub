...
INSERT INTO rss_feed_configs (name, url, output_dir, enabled, transcript_mandatory) VALUES
    ...
    ('John Savill''s Technical Training',        'https://www.youtube.com/feeds/videos.xml?channel_id=UCpIn7ox7j7bH_OFj7tYouOQ',                     '_videos',    TRUE,  TRUE),
    ('DotNet YouTube',                           'https://www.youtube.com/feeds/videos.xml?channel_id=UCvtT19MZW8dq5Wwfu6B0oxw',                     '_videos',    TRUE,  TRUE),
    ('GitHub YouTube',                           'https://www.youtube.com/feeds/videos.xml?channel_id=UC7c3Kb6jYCRj4JOHHZTxKsQ',                     '_videos',    TRUE,  TRUE),
    ('Learn Microsoft AI Youtube',               'https://www.youtube.com/feeds/videos.xml?channel_id=UCQf_yRJpsfyEiWWpt1MZ6vA',                     '_videos',    TRUE,  TRUE),
    ...
    ('Microsoft Cloud YouTube',                  'https://www.youtube.com/feeds/videos.xml?channel_id=UCSgzRJMqIiCNtoM6Q7Q9Lqw',                     '_videos',    TRUE,  TRUE),
    ...
    ('Nick Chapsas YouTube',                     'https://www.youtube.com/feeds/videos.xml?channel_id=UCrkPsvLGln62OMZRO6K-llg',                     '_videos',    TRUE,  TRUE),
    ...
    ('Visual Studio Code YouTube',               'https://www.youtube.com/feeds/videos.xml?channel_id=UCs5Y5_7XK8HLDX0SLNwkd3w',                     '_videos',    TRUE,  TRUE),
    ('Microsoft Developer YouTube',              'https://www.youtube.com/feeds/videos.xml?channel_id=UCsMica-v34Irf9KVTh6xx-g',                     '_videos',    TRUE,  TRUE),
    ('Microsoft Events YouTube',                 'https://www.youtube.com/feeds/videos.xml?channel_id=UCrhJmfAGQ5K81XQ8_od1iTg',                     '_videos',    TRUE,  TRUE),
    ...
    ('Alireza Chegini''s YouTube',               'https://www.youtube.com/feeds/videos.xml?channel_id=UCZSAqzABRmDxDHuPS6YuXZA',                     '_videos',    TRUE,  TRUE),
    ...
    ('Authorised Territory''s YouTube',          'https://www.youtube.com/feeds/videos.xml?channel_id=UCR2VG1Rq7abZ33S1T3XSWNg',                     '_videos',    TRUE,  TRUE),
    ...
    ('Microsoft Build 2025 YouTube',             'https://www.youtube.com/feeds/videos.xml?playlist_id=PLlrxD0HtieGidlsr4FzmSFpjMU1gOGGAf',         '_videos',    FALSE, TRUE),
