...
description: "This session from Microsoft Ignite 2025 explores how Microsoft Purview Data Security Investigations (DSI) leverages AI for deep content analysis to proactively and reactively secure sensitive data. It covers the integration between Microsoft Purview and Defender, the use of AI-driven techniques like intent mapping and embeddings, observability in risk detection, and real-world customer stories including Toyota Motor North America's experience. The session aims to inform security and SOC teams on scaling investigations with advanced Microsoft tools."
