...
description: "This session, featuring Vic Perdana, Katie Savage, and Maira Wenzel, demonstrates how to develop practical AI agents using the new Agent Framework (AF)—the evolutionary successor to Semantic Kernel and Autogen—with Azure AI Foundry. The talk focuses on building interoperable, composable agents, real-world orchestration patterns, and integrating both local and cloud-based LLMs. It showcases SemantiClip, an open-source AI project that converts video to blog content by leveraging AF, structured memory via Model Context Protocol (MCP), and best practices for persistent, context-aware workflows."
author: "dotnet"
excerpt_separator: <!--excerpt_end-->
canonical_url: "https://www.youtube.com/watch?v=1k2jyvmx3i0"
...
- [Agent Framework documentation](https://github.com/microsoft/agentframework) (if public)
- [SemantiClip project repository](https://github.com/semanticlip) (if public)
