...
- [Read the .NET Blog](https://aka.ms/dotnet/blog)
- [Learn .NET](https://aka.ms/learndotnet)

## Community and Support

- [Microsoft Q&A for .NET](https://aka.ms/dotnet-qa)
- [.NET Forums](https://aka.ms/dotnet/forums)
- [.NET Twitter](https://aka.ms/dotnet/twitter)
- [.NET LinkedIn](https://aka.ms/dotnet/linkedin)
