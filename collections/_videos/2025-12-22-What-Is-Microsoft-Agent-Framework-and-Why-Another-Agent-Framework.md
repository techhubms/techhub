...
description: "This video introduces the Microsoft Agent Framework, an open-source AI development kit for building LLM-powered agents and multi-agent workflows using .NET and Python. It explains Agent Framework’s structure, its relationship to Semantic Kernel and AutoGen, and the advantages of adopting a unified approach for enterprise and advanced AI agent scenarios."
...
- **Microsoft Agent Framework Repository:** (Check the official Microsoft AI GitHub organization)
