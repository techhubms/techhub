...
# Can You Really Trust AI to Optimize Your Cloud?

**Speaker:** Suresh Mathew, CEO of Sedai
**Event:** Microsoft Ignite 2025
**Session:** ODSP1433

## Overview

Operating hundreds of services in an enterprise cloud is costly and labor-intensive. Many engineering leaders are adopting AI-powered solutions to manage tasks such as resource rightsizing and resolving availability issues. This session examines whether it's truly safe to rely on AI for cloud optimization and the consequences when failures occur.
...
AI is increasingly central to cloud management within enterprise environments. Architectural teams must carefully balance the productivity gains and automation benefits against the risks and reliability challenges posed by full reliance on intelligent systems.
