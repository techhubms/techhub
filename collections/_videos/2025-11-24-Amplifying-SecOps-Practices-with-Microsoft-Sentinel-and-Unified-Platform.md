...
This Microsoft Ignite 2025 session highlights the transformation of security operations for partners through the Modern SecOps with Unified Platform solution. Learn how new capabilities in Microsoft Sentinel—including its data lake and graph features—enhance threat detection, investigation, and response. The session also covers predictive SOC (Security Operations Center) strategies and the Secure Future Initiative (SFI).
...
- Nationwide’s enterprise-scale Sentinel implementation
- Examples of interactive threat hunting and predictive SOC enablement

### For Partners

- Key resources to drive impactful engagements
- How to leverage incentives and workshops for growth
- Building long-term, customer-centric SecOps practices

### Additional Information

- Session code: PBRK248
- Speakers: Max McWilliams, Anne Stobaugh, Scott Woodgate
- Additional related sessions: [PBRK273](https://ignite.microsoft.com/sessions/PBRK273?wt.mc_id=yt_PLQXpv_NQsPIDXiR9PcpggZ34mzko_-12C;PLQXpv_NQsPICW4BSlBsvN7PTJRcTrXEsY), [PBRK272](https://ignite.microsoft.com/sessions/PBRK272?wt.mc_id=yt_PLQXpv_NQsPIDXiR9PcpggZ34mzko_-12C;PLQXpv_NQsPICW4BSlBsvN7PTJRcTrXEsY)

### Learn More

- Access session on-demand: [Microsoft Ignite](https://ignite.microsoft.com)
