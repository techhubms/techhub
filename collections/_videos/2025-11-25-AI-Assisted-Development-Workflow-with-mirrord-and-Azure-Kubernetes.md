...
- [Debugging Apps on AKS with mirrord – YouTube](https://youtu.be/0tf65d5rn1Y)
- [Open at Microsoft](https://aka.ms/OpenAtMicrosoft)
- [OSS Project Submission](https://aka.ms/OpenAtMsCFP)

## Hosts & Contributors

- **Jorge Arteiro** ([LinkedIn](https://www.linkedin.com/in/jorgearteiro))
- **Arsh Sharma** ([LinkedIn](https://www.linkedin.com/in/arsh4/))
