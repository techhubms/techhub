...
- [Official Microsoft Documentation – Set up Model Context Protocol server (Standard)](https://learn.microsoft.com/azure/logic-apps/set-up-model-context-protocol-server-standard)
- [Whiteboard Diagram](https://github.com/johnthebrit/RandomStuff/raw/master/Whiteboards/LogicAppsandMCP.png)
