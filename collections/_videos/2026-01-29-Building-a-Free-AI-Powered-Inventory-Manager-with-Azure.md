...
The solution is designed to be budget-friendly, with options to get started for free through the offered Azure resources at [aka.ms/budgetbytes/freeoffer](https://aka.ms/budgetbytes/freeoffer). All code and templates are available in the [official repository](https://aka.ms/budgetbytes).
...
- Repo: [aka.ms/budgetbytes](https://aka.ms/budgetbytes)  
- Free Offer: [aka.ms/budgetbytes/freeoffer](https://aka.ms/budgetbytes/freeoffer)
