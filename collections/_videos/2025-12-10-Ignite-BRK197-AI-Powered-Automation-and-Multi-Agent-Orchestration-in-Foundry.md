...
- [Join the Microsoft Foundry Discord](https://aka.ms/AIDevDays/Discord) for discussions and support
- [Sign up for an Azure Free Trial](https://aka.ms/AzureFreeTrialYT) to get started
- [Hands-on MCP Lab Repository](https://aka.ms/AIDevDays/LabDay1)
- [Catch up with on-demand content](https://aka.ms/AIDevDays/OnDemand)
