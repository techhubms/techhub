...
- [.NET 10](https://aka.ms/dotnet10/): Unified, intelligent .NET platform
- [.NET Aspire 13](https://aka.ms/aspire13/announcement): Cloud-native app orchestration
- [ASP.NET Core 10](https://aka.ms/asp/dotnet/2025): Secure, full-stack web development
- [.NET MAUI 10](https://aka.ms/dotnet/maui/2025): Cross-platform, modern app UI
- [C# 14](https://aka.ms/csharp14/announcement/2025): Productivity enhancements in C#
- [F# 10](https://aka.ms/fsharp10/2025/announcement): Advances in functional programming
- [Visual Studio 2026](https://aka.ms/visualstudio2026/announcement): Future-ready IDE
...
- [Docs & Q&A](https://learn.microsoft.com/dotnet)
- [Microsoft Learn](https://aka.ms/learndotnet)
- [Forums and Social Links](https://aka.ms/dotnet/forums)
