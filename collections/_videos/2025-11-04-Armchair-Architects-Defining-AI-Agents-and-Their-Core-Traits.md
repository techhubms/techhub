...
- [Agent Factory: Designing the open agentic web stack](https://azure.microsoft.com/blog/agent-factory-designing-the-open-agentic-web-stack/)
- [Azure Architecture Center](https://learn.microsoft.com/azure/architecture)
- [AI Architecture Design](https://learn.microsoft.com/azure/architecture/ai-ml)
- [Get started with AI agent development on Azure](https://learn.microsoft.com/training/modules/ai-agent-fundamentals)

## Related Episodes

- [More Armchair Architects](https://aka.ms/ArmchairArchitects)
- [More Azure Essentials Show](https://aka.ms/AzureEssentialsShow)
