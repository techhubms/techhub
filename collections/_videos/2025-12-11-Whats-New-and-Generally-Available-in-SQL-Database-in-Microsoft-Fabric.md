...
- Guides and sample apps to accelerate onboarding: [Learn more](https://aka.ms/announcingsqlfabric)
- Example applications for reference: [AI App sample](https://aka.ms/AgenticAppFabric), [Baking App demo](https://aka.ms/SQLinFabricIgniteDemo)
- Ignite and general availability session: [Session recording](https://aka.ms/SQLinFabricIgniteSession)
