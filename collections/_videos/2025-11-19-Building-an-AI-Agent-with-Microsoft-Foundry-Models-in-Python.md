...
permalink: "/videos/2025-11-19-Building-an-AI-Agent-with-Microsoft-Foundry-Models-in-Python.html"
...
Start by deploying an AI model in Microsoft Foundry. Access the Foundry portal here: [Microsoft Foundry](https://ai.azure.com).
...
- Follow the sample code for agent creation ([Sample Code](https://aka.ms/insideMF/samples))
...
- [Learn More about Azure AI Foundry Model and Tools](https://aka.ms/model-mondays)
- [Join the InsideMF Discord community](https://aka.ms/insideMF/discord)
- [Participate in discussions on the InsideMF Forum](https://aka.ms/insideMF/forum)
