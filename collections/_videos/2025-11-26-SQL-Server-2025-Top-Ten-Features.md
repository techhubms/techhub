...
- [Certification Content Repo](https://github.com/johnthebrit/CertificationMaterials)
- [Weekly Azure Update](https://youtube.com/playlist?list=PLlVtbbG169nEv7jSfOVmQGRp9wAoAM0Ks)

For more detailed chapters and timestamps, see the original video description.
...
For channel updates, subtitles, and FAQs, check the channel page and resources listed in the description.
