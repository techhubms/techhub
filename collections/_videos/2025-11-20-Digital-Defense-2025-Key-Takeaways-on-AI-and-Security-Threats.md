...
For further resources and session details:

- [Proactive Security Ops at Microsoft Ignite](https://aka.ms/ignite25-plans-ProactiveSecurityOps)
- [Microsoft Ignite on-demand sessions](https://ignite.microsoft.com)

For regular updates, check out the Microsoft Threat Intelligence Podcast.

---

This session was presented as a foundational (100-level) breakout at Microsoft Ignite 2025 (#MSIgnite, #ModernizeSecOpswithaunifiedplatform).
