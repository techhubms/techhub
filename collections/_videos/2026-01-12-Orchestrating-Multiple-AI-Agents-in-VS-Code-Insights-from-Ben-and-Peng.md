...
**Host:** James (VS Code Team)
**Guests:** Ben & Peng (VS Code Product Team)
...
- [v1.108 VS Code Release Notes](https://code.visualstudio.com/updates/v1_108)
- [VS Code Agents Overview](https://code.visualstudio.com/docs/copilot/agents/agents-tutorial)
...
For more, subscribe to the [VS Code Insiders Podcast](https://www.vscodepodcast.com/subscribe) or follow the VS Code team on their social channels.
