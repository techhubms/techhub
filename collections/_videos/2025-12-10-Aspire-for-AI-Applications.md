...
- **Hands-On Labs:** Access practical lab resources via the [MCP lab repo](https://aka.ms/AIDevDays/LabDay1) to try out Aspire features firsthand.

## Resources and Community

- **Microsoft Foundry Discord:** Join the community for discussions and support: [https://aka.ms/AIDevDays/Discord](https://aka.ms/AIDevDays/Discord)
- **Azure Free Trial:** Start developing on Azure: [https://aka.ms/AzureFreeTrialYT](https://aka.ms/AzureFreeTrialYT)
- **On-Demand Content:** Watch sessions at your convenience: [https://aka.ms/AIDevDays/OnDemand](https://aka.ms/AIDevDays/OnDemand)
