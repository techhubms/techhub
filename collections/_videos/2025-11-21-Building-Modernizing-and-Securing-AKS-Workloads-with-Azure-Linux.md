...
- [Microsoft Ignite - Migrate and Modernize Your Estate Session](https://ignite.microsoft.com)
- [Plans to migrate Linux PostgreSQL on Azure](https://aka.ms/ignite25-plans-migrateLinuxPostgreSQL)
