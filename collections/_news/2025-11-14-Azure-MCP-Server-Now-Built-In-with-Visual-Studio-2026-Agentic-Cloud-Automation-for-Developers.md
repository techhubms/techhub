...
1. Download [Visual Studio 2026](https://visualstudio.microsoft.com/) or [Insiders Edition](https://visualstudio.microsoft.com/insiders/) and run the installer.
...
![Tool Selection Screenshot](https://devblogs.microsoft.com/visualstudio/wp-content/uploads/sites/4/2025/11/AzureDevelopmentToolSelection.webp)

For full guidance, see [Get started with GitHub Copilot for Azure](https://learn.microsoft.com/en-us/azure/developer/github-copilot-azure/get-started?pivots=visual-studio-2026#install-github-copilot-for-azure).
...
- [Azure MCP Overview](https://learn.microsoft.com/en-us/azure/developer/azure-mcp-server/overview)
...
This post appeared first on "Microsoft VisualStudio Blog". [Read the entire article here](https://devblogs.microsoft.com/visualstudio/azure-mcp-server-now-built-in-with-visual-studio-2026-a-new-era-for-agentic-workflows/)
