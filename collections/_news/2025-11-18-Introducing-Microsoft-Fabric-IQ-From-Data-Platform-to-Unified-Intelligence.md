...
- [Fabric IQ documentation](https://aka.ms/Fabric-iq-overview)
- [Ontology concepts](https://aka.ms/ontology-concepts)
...
- [Register for FabCon Atlanta](https://aka.ms/fabcon)
- [Watch Ignite sessions](https://ignite.microsoft.com/sessions/BRK1702)
- [Get started with a tutorial](https://aka.ms/ontology-tutorial)
...
This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/from-data-platform-to-intelligence-platform-introducing-microsoft-fabric-iq/)
