...
Delivering high-quality software demands robust tools for clarity, speed, and team collaboration. The Azure DevOps team is announcing the general availability (GA) of the new [Test Run Hub](https://learn.microsoft.com/en-us/azure/devops/test/test-runs?view=azure-devops) within Azure Test Plans, rolling out to all organizations throughout January 2026.
...
Users are encouraged to share ideas or report issues through the [Azure DevOps Developer Community](https://developercommunity.visualstudio.com/AzureDevOps) portal.
...
This post appeared first on "Microsoft DevOps Blog". [Read the entire article here](https://devblogs.microsoft.com/devops/the-new-test-run-hub-is-going-generally-available/)
