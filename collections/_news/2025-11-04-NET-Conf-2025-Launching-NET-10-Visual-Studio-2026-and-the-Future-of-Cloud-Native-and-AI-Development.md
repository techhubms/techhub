...
[.NET Conf 2025](https://dotnetconf.net) is nearly here, taking place November 11-13 as a free, virtual event for developers worldwide. The conference marks the release of .NET 10 and Visual Studio 2026 and features sessions led by Microsoft product teams, industry experts, and community leaders.
...
- Watch live at [dotnetconf.net](https://dotnetconf.net) via YouTube or Twitch, or view session recordings afterwards.
- Ask questions, chat live with session moderators, and download session demo code from GitHub.
- Find [local .NET Conf events](https://aka.ms/dotnetconf/localevents/submission) in your area for in-person learning opportunities.

## More Resources

- [Schedule and Agenda](https://www.dotnetconf.net/agenda)
- [YouTube Channel](https://youtube.com/dotnet)
- [Community Sessions](https://dotnetconf.net)
- [Student Zone Info](https://www.dotnetconf.net/save-date/student-zone)
...
This post appeared first on "Microsoft .NET Blog". [Read the entire article here](https://devblogs.microsoft.com/dotnet/get-ready-for-dotnet-conf-2025/)
