...
description: "This article explores how the latest version of the VS Code Container Tools extension integrates GitHub Copilot to streamline and simplify container management. Developers can now use conversational commands inside Visual Studio Code to inspect, troubleshoot, and restart containers, boosting efficiency and keeping their workflow focused on coding."
...
1. A container crashes during development.
2. Right-click to open **Ask Copilot** for that container.
3. Copilot analyzes the logs, highlights errors, and suggests fixes.
4. The developer can instruct Copilot to restart the container directly.
5. Progress updates and confirmation are handled within VS Code.
...
This post appeared first on "Microsoft Blog". [Read the entire article here](https://devblogs.microsoft.com/blog/manage-containers-the-easy-way-copilot-vs-code)
