...
- Official SQL Database in Fabric documentation: [Learn More](https://learn.microsoft.com/sql/sql-server/fabric-database/sql-database-in-fabric?view=azuresqldb-current)
- Video playlist: [YouTube](https://aka.ms/fabricsqlyt)
- Agentic app sample: [GitHub](https://aka.ms/AgenticAppFabric)
- RAG pipeline sample: [Awesome Azure SQL](https://ai.awesome.azuresql.dev/)
- Community forums: [Fabric Forums](https://community.fabric.microsoft.com/t5/Databases-preview-forums/ct-p/databases)
- Security documentation: [SQL Auditing](https://learn.microsoft.com/azure/azure-sql/database/auditing-overview), [CMK](https://aka.ms/fabric-sqldb-encryption)
...
This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/announcing-sql-database-in-fabric-is-now-generally-available-ga/)
