...
- **Partner Ecosystem:** Explore Microsoft and third-party agents in the [Microsoft Security Store](https://securitystore.microsoft.com/)
- **Documentation:** Learn about activation and eligibility at [aka.ms/scpinclusioninfo](https://aka.ms/scpinclusioninfo)
- **Learn More:** Visit [Microsoft Security Blog](https://www.microsoft.com/security/blog/) and follow [Microsoft Security](https://www.linkedin.com/showcase/microsoft-security/)
...
This post appeared first on "Microsoft Security Blog". [Read the entire article here](https://www.microsoft.com/en-us/security/blog/2025/11/18/agents-built-into-your-workflow-get-security-copilot-with-microsoft-365-e5/)
