...
- [Fabric Databases Documentation](https://learn.microsoft.com/fabric/database/)
- [SQL Database in Fabric Overview](https://learn.microsoft.com/fabric/database/sql/overview)
- [Cosmos DB in Fabric Overview](https://learn.microsoft.com/en-us/fabric/database/cosmos-db/)
- [Modern Data, Modern Apps: Innovation with Microsoft Databases](https://ignite.microsoft.com/sessions/BRK134?source=sessions)
- [SQL Database in Fabric for AI Apps and Analytics](https://ignite.microsoft.com/sessions/BRK220?source=sessions)
- [Real-Time Analytics and AI Apps with Cosmos DB in Fabric](https://ignite.microsoft.com/sessions/BRK228?source=sessions)
...
This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/fabric-databases-a-unified-saas-native-experience-for-modern-data-workloads-generally-available/)
