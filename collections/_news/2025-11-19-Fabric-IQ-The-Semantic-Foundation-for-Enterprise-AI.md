...
- [Ontology creation tutorial](https://aka.ms/ontology-sm-tutorial)
- [Fabric IQ docs](https://aka.ms/Fabric-iq-overview)
- [Forum for questions](http://aka.ms/fabric-iq-forum)
- [Blog](https://aka.ms/fabricblog)
- [YouTube](https://aka.ms/fabricyoutube)
- [Release plan](https://aka.ms/fabricreleaseplan)

Explore further documentation, submit ideas, or jumpstart your first ontology for enterprise semantic AI with Fabric IQ.

This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/introducing-fabric-iq-the-semantic-foundation-for-enterprise-ai/)
