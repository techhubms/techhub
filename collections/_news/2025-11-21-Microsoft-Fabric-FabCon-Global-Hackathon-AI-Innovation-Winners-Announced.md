...
Developers completed the [Fabric Hackathon Skilling Plan](https://aka.ms/FabConHack-SkillingPlan), then submitted projects in these categories:
...
[View on GitHub](https://github.com/Data4all-AI/hero)

### Best AI App: Smart Waste Management for Dallas City
...
[View on GitHub](https://github.com/Sammychesire/Smart-City-Waste-Management)

### Best Use of AI Features: FabricAgent
...
[View on GitHub](https://github.com/cdrguru/fabricagent-fabcon2025)

### Best Analytics Solution: Fabric Intelligence
...
[View on GitHub](https://github.com/longphamkhac/Fabric-Intelligence-Unified-Analytics-and-Real-time-RAG-based-Review-Aware-Product-Recommendation)

### Best Real-Time Intelligence: SmartNexxie
...
[View on GitHub](https://github.com/danielmuthama23/SmartNexxie--Microsoft-Fabcon-Global-Hack-AI-Smart-Parking)

### Best Open Mirroring: Enterprise Finance Migration Accelerator

Enables fast, secure migration from Snowflake to Microsoft Fabric, automating RBAC and delivering major cost savings.

[View on GitHub](https://github.com/tyler-migration/enterprise-finance-migration-accelerator)
...
- [DP-600 Fabric Data Analytics Engineer Challenge](https://aka.ms/Ignite-FabricDataAnalyticsChallenge)
- [DP-700 Fabric Data Engineer Challenge](https://aka.ms/Ignite-FabricDataEngineerChallenge)
- [Register for Fabric Data Days](https://aka.ms/FabricDataDays)
- [FabCon Atlanta Registration](https://aka.ms/fabcon) (Code: FABHACK)
...
This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/announcing-the-winners-of-the-microsoft-fabric-fabcon-global-hack/)
