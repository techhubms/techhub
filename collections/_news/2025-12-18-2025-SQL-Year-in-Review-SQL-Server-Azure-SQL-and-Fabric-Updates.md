...
- Weekly content on the [Azure SQL YouTube channel](https://aka.ms/AzureSQLYT) and new Data Exposed episodes.
- Regular updates and conversations via [@AzureSQL on Twitter](https://twitter.com/AzureSQL) and blog series.
...
- [2025 Year in Review Post](https://blog.fabric.microsoft.com/en-us/blog/2025-year-in-review-whats-new-across-sql-server-azure-sql-and-sql-database-in-fabric/)
...
This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/2025-year-in-review-whats-new-across-sql-server-azure-sql-and-sql-database-in-fabric/)
