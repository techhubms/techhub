...
![URL Context Feature](https://devblogs.microsoft.com/visualstudio/wp-content/uploads/sites/4/2025/11/18.0_url_context.webp)
...
Explore the [Visual Studio Hub](https://visualstudio.microsoft.com/hub/) for release notes, videos, and community updates. For feedback or suggestions, visit the [Developer Community](https://developercommunity.visualstudio.com/VisualStudio).
...
This post appeared first on "Microsoft VisualStudio Blog". [Read the entire article here](https://devblogs.microsoft.com/visualstudio/unlocking-the-power-of-web-with-copilot-chats-new-url-context/)
