...
- [Download Visual Studio 2026](https://visualstudio.com/download)
- [Explore Aspire 13](https://aka.ms/aspire/13/download)
- [GitHub Copilot modernization](https://aka.ms/ghcp-appmod/net)
- [Agent Framework & MCP](https://github.com/microsoft/agent-framework)
- [On-demand recordings and slides](https://aka.ms/dotnetconf25/OnDemand)
- [Student Zone for new developers](https://www.youtube.com/watch?v=-c8r2fMi9cg)
...
For a complete review of every session, announcement, and technical deep dive, watch the [official YouTube playlist](https://aka.ms/dotnetconf25/OnDemand) and access sample code, slides, and digital swag from the [.NET Conf 2025 GitHub page](https://aka.ms/dotnetconf-slides).

Let’s keep building with .NET, AI, Azure, and empower the next generation of developers.

This post appeared first on "Microsoft .NET Blog". [Read the entire article here](https://devblogs.microsoft.com/dotnet/dotnet-conf-2025-recap/)
