...
- [Create a semantic foundation for your AI agents in Microsoft Fabric](https://ignite.microsoft.com/en-US/sessions/BRK222)
- [Unlock the power of Real-Time Intelligence in the era of AI](https://ignite.microsoft.com/en-US/sessions/BRK226)
- [Explore the docs](https://aka.ms/realtimedocs)
- [Customer success stories](https://aka.ms/fabric-customer-success)
- [Tutorials and learning paths](https://aka.ms/realtimetutorial), [Certification](https://aka.ms/realtimelearningpath)
...
This post appeared first on "Microsoft Fabric Blog". [Read the entire article here](https://blog.fabric.microsoft.com/en-US/blog/microsoft-fabric-real-time-intelligence-a-leader-in-the-2025-forrester-streaming-data-wave/)
