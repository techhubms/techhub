...
[Learn more about Azure Copilot.](http://aka.ms/ignite25/azurecopilotblog)  
[Sign up for the Copilot preview.](http://aka.ms/azurecopilot/agents/feedbackprogram)
...
Read more on [GitHub Copilot app modernization](http://aka.ms/AppModernizationBlog).
...
For more technical sessions and in-depth content, see:

- [Innovation Session: Scale Smarter: Infrastructure for the Agentic Era](https://ignite.microsoft.com/en-US/sessions/BRK1704?source=sessions)
- [End-to-End migration with AI Agents](https://ignite.microsoft.com/en-US/sessions/brk140?source=sessions)
- [Unlock agentic intelligence with Copilot in Azure](https://ignite.microsoft.com/en-US/sessions/brk145?source=sessions)
- [Scaling Kubernetes securely with AKS](https://ignite.microsoft.com/en-US/sessions/BRK120?source=sessions)
- [Inside Azure Innovations](https://ignite.microsoft.com/en-US/sessions/BRK430?source=sessions)

This post appeared first on "The Azure Blog". [Read the entire article here](https://azure.microsoft.com/en-us/blog/announcing-azure-copilot-agents-and-ai-infrastructure-innovations/)
