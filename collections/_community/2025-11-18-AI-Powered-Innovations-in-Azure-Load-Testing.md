...
- The AI-powered authoring feature launches in a few weeks.
- The [AI-powered insights feature](https://learn.microsoft.com/en-us/azure/app-testing/load-testing/how-to-analyze-test-results-using-actionable-insights) is available now for Azure Load Testing users.
- Feedback is welcomed via [this form](https://aka.ms/malt-feedback).
...
This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/apps-on-azure-blog/ai-powered-performance-testing/ba-p/4471029)
