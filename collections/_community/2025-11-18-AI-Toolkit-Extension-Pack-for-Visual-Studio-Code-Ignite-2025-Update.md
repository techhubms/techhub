...
- Integrate tracing hooks and test scaffolds, powered by Copilot and aligned with the [Microsoft Agent Framework](https://learn.microsoft.com/en-us/agent-framework/overview/agent-framework-overview).
...
- **Install the** [Foundry SDK](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/develop/sdk-overview?pivots=programming-language-python) and review additional documentation.

## Feedback & Support

Submit any issues or feature requests to the [GitHub repo for Foundry extension](https://github.com/microsoft/ai-foundry-for-vscode/issues) and [AI Toolkit extension](https://github.com/microsoft/vscode-ai-toolkit/issues). Community feedback is encouraged to enhance these tools further.

_Last updated: November 18, 2025 — Version 1.0, by leoyao_

This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/microsoft-developer-community/ai-toolkit-extension-pack-for-visual-studio-code-ignite-2025/ba-p/4471050)
