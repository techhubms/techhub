...
1. Sign in at [https://ai.azure.com](https://ai.azure.com/) and create a Foundry project.
...
For a deep dive and hands-on labs, see [Microsoft Learn's training resources](https://learn.microsoft.com/training) and the [skilling plan for this series](https://learn.microsoft.com/en-gb/plans/kx1b2ty2grgzz?wt.mc_id=youtube_26511_organicsocial_reactor).

## Join the Community

- [Discord](https://aka.ms/foundry/discord): Connect with other developers building agentic solutions
- [GitHub Discussions](https://aka.ms/foundrydevs): Share ideas and troubleshoot with the community
- Office Hours: Access direct support from Microsoft product teams

### Final Thoughts

Agentic AI is reshaping how work gets done by letting intelligent systems act, learn, and collaborate. Microsoft Foundry equips developers to build secure, scalable, and intelligent agents—today, not in the future. Join the sessions and community to accelerate your journey: [https://aka.ms/AzureSkilling-Ignite/25](https://aka.ms/AzureSkilling-Ignite/25)

---

*Posted by Lee_Stott, Microsoft Developer Community Blog*

This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/microsoft-developer-community/exploring-the-future-of-ai-agents-with-microsoft-foundry/ba-p/4476107)
