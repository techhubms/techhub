...
- **Orchestration:** Leverage the [Microsoft Agent Framework](https://github.com/microsoft/agent-framework) for agent lifecycle management and workflow visualization.
...
- Install the [AI Toolkit for Visual Studio Code](https://aka.ms/aitoolkit).
...
- Share feedback or request features on the [GitHub repo](https://github.com/microsoft/vscode-ai-toolkit/issues).
...
This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/microsoft-developer-community/announcing-public-preview-ai-toolkit-for-github-copilot-prompt/ba-p/4465069)
