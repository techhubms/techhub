...
- [Product overview](https://aka.ms/sreagent/docs)
- [Deployment samples](https://github.com/microsoft/sre-agent/tree/main/samples)
- [Demo recordings](https://aka.ms/sreagent/youtube)

## Providing Feedback

Feedback can be submitted directly within the agent, through issue creation, or in the [GitHub repo](https://github.com/microsoft/sre-agent).
...
This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/apps-on-azure-blog/reimagining-ai-ops-with-azure-sre-agent-new-automation/ba-p/4462613)
