...
- Create your first AKS cluster or deploy an application through the 'Deploy Your Application' workflow in Kubernetes Center.
- View documentation and quickstarts directly within the interface.
- Access the preview at [Kubernetes Center on Azure Portal](https://portal.azure.com/#view/Microsoft_Azure_KubernetesFleet/KubernetesHub.MenuView/~/overview).
- Additional resources: [Azure Kubernetes Center Documentation](https://learn.microsoft.com/en-us/azure/aks/kubernetes-center-azure-portal)
...
This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/azure-infrastructure-blog/announcing-kubernetes-center-preview-on-azure-portal/ba-p/4471110)
