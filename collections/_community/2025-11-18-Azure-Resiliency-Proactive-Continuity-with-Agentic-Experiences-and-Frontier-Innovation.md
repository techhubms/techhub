...
- [Azure Copilot Resiliency Agent (Preview)](https://review.learn.microsoft.com/en-us/azure/copilot/agents-preview?branch=release-ignite-azure-copilot)
- [Resiliency in Azure Portal](https://portal.azure.com/?feature.customPortal=false)
- [Ignite Announcement Blog](https://aka.ms/Ignite2025/Resiliencyblog)

## Three Pillars of Azure Resiliency
...
- [Resiliency in Azure (Portal)](https://portal.azure.com/?feature.customPortal=false)
- [Resiliency in Azure (Learn Docs)](https://learn.microsoft.com/en-us/azure/resiliency/)
- [Agents (Preview) in Azure Copilot](https://review.learn.microsoft.com/en-us/azure/copilot/agents-preview?branch=release-ignite-azure-copilot)
- [Resiliency Solutions](https://azure.microsoft.com/en-us/solutions/resiliency)
...
- [Ignite Session Catalog](https://ignite.microsoft.com/en-US/sessions)

#### Ignite 2025 Sessions On-Demand

- [Resilience by Design: Secure, Scalable, AI-Ready Cloud with Azure (BRK217)](https://ignite.microsoft.com/en-US/sessions/BRK217?source=sessions)
- [Resiliency & Recovery with Azure Backup and Site Recovery (BRK146)](https://ignite.microsoft.com/en-US/sessions/BRK146?source=sessions)
- [Architect Resilient Apps with Azure Backup and Reliability Features (BRK148)](https://ignite.microsoft.com/en-US/sessions/BRK148?source=sessions)
- [Architecting for Resiliency on Azure Infrastructure (BRK178)](https://ignite.microsoft.com/en-US/sessions/BRK178?source=sessions)
...
For updates and technical insights, follow the Azure Architecture Blog.

This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/azure-architecture-blog/azure-resiliency-proactive-continuity-with-agentic-experiences/ba-p/4469693)
