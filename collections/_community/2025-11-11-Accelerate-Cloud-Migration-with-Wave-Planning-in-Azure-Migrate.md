...
- [Azure Migrate – Wave planning](https://review.learn.microsoft.com/en-us/azure/migrate/how-to-plan-create-waves?view=migrate)
- [Cloud Adoption Framework: Wave Planning Guidance](https://learn.microsoft.com/en-us/azure/cloud-adoption-framework/migrate/migration-wave-planning)
- [Overview of Azure Migrate](https://learn.microsoft.com/azure/migrate/?view=migrate)
- [Application-centric migration in Azure Migrate](https://techcommunity.microsoft.com/blog/azuremigrationblog/migrate-or-modernize-your-applications-using-azure-migrate/4468587)

*Updated: Nov 11, 2025*

This post appeared first on "Microsoft Tech Community". [Read the entire article here](https://techcommunity.microsoft.com/t5/azure-migration-and/accelerate-cloud-migration-with-wave-planning-in-azure-migrate/ba-p/4467959)
