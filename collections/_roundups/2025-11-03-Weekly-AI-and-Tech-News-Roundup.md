...
- [Introducing Agent HQ Mission Control for GitHub Copilot]({{ "/2025-10-28-Introducing-Agent-HQ-Mission-Control-for-GitHub-Copilot.html" | relative_url }})
...
- [Introducing Plan Mode: Build Better Plans with GitHub Copilot]({{ "/2025-10-29-Introducing-Plan-Mode-Build-Better-Plans-with-GitHub-Copilot.html" | relative_url }})
...
- [GitHub Universe 2025 Day 1 Recap: Announcements and New Features]({{ "/2025-10-29-GitHub-Universe-2025-Day-1-Recap-Announcements-and-New-Features.html" | relative_url }})
- [GitHub Universe Day 1 Keynote Recap: Agent HQ, Mission Control, and Custom Agents]({{ "/2025-10-28-GitHub-Universe-Day-1-Keynote-Recap-Agent-HQ-Mission-Control-and-Custom-Agents.html" | relative_url }})
...
- [OpenAI Codex Now Available in VS Code with GitHub Copilot Pro+]({{ "/2025-10-28-OpenAI-Codex-Now-Available-in-VS-Code-with-GitHub-Copilot-Pro.html" | relative_url }})
...
- [AI-Assisted Modernization and Cloud Migration of Legacy Java Applications with GitHub Copilot]({{ "/2025-11-01-AI-Assisted-Modernization-and-Cloud-Migration-of-Legacy-Java-Applications-with-GitHub-Copilot.html" | relative_url }})
- [Upgrade MSVC with GitHub Copilot App Modernization for C++]({{ "/2025-10-29-Upgrade-MSVC-with-GitHub-Copilot-App-Modernization-for-C.html" | relative_url }})
...
- [Introduction to GitHub Copilot Coding Agent]({{ "/2025-10-30-Introduction-to-GitHub-Copilot-Coding-Agent.html" | relative_url }})
- [Exploring GitHub Copilot Coding Agent: Beyond Code Suggestions]({{ "/2025-10-30-Exploring-GitHub-Copilot-Coding-Agent-Beyond-Code-Suggestions.html" | relative_url }})
...
- [MCP and Java Apps: Building a Server]({{ "/2025-10-30-MCP-and-Java-Apps-Building-a-Server.html" | relative_url }})
- [Building MCP Clients: Java Integration and GitHub Copilot Use Cases]({{ "/2025-10-31-Building-MCP-Clients-Java-Integration-and-GitHub-Copilot-Use-Cases.html" | relative_url }})
...
- [Context Engineering for Java Ecosystem]({{ "/2025-10-31-Context-Engineering-for-Java-Ecosystem.html" | relative_url }})
...
- [Building a 2D Platformer with Spec Kit, VS Code, and GitHub Copilot]({{ "/2025-10-30-Building-a-2D-Platformer-with-Spec-Kit-VS-Code-and-GitHub-Copilot.html" | relative_url }})
- [How GitHub Copilot Hacked a Furby]({{ "/2025-10-30-How-GitHub-Copilot-Hacked-a-Furby.html" | relative_url }})
...
- [Collapsing the Distance from Idea to Impact with GitHub Copilot and AI-Powered Development]({{ "/2025-10-29-Collapsing-the-Distance-from-Idea-to-Impact-with-GitHub-Copilot-and-AI-Powered-Development.html" | relative_url }})
...
- [Deep Dive into Microsoft Agent Framework for AutoGen Users]({{ "/2025-10-30-Deep-Dive-into-Microsoft-Agent-Framework-for-AutoGen-Users.html" | relative_url }})
- [Building Real-World AI Agents with Agent Framework on .NET Live]({{ "/2025-11-02-Building-Real-World-AI-Agents-with-Agent-Framework-on-NET-Live.html" | relative_url }})
...
- [Introducing Agent HQ: Your Mission Control for AI Agents]({{ "/2025-10-28-Introducing-Agent-HQ-Your-Mission-Control-for-AI-Agents.html" | relative_url }})
...
- [Responsible AI for Java Developers: Building Safe and Trustworthy Applications]({{ "/2025-10-30-Responsible-AI-for-Java-Developers-Building-Safe-and-Trustworthy-Applications.html" | relative_url }})
...
- [Getting Started with Generative AI for Java Developers Using GitHub Codespaces]({{ "/2025-10-28-Getting-Started-with-Generative-AI-for-Java-Developers-Using-GitHub-Codespaces.html" | relative_url }})
- [GenAI for Java Developers 2: Core Techniques Explained]({{ "/2025-10-29-GenAI-for-Java-Developers-2-Core-Techniques-Explained.html" | relative_url }})
- [Building Three AI-Powered Applications: MCP, Browser LLMs, and Foundry Local]({{ "/2025-10-29-Building-Three-AI-Powered-Applications-MCP-Browser-LLMs-and-Foundry-Local.html" | relative_url }})
- [Intro to Java and AI for Beginners]({{ "/2025-10-28-Intro-to-Java-and-AI-for-Beginners.html" | relative_url }})
...
- [Octoverse 2025: AI, India, and TypeScript's Rise]({{ "/2025-10-28-Octoverse-2025-AI-India-and-TypeScripts-Rise.html" | relative_url }})
...
- [Implementing Vector Search in Your Application with SQL Server 2025]({{ "/2025-10-27-Implementing-Vector-Search-in-Your-Application-with-SQL-Server-2025.html" | relative_url }})
...
- [Building Event-Driven Apps with Fabric Real-Time Intelligence and SQL]({{ "/2025-10-30-Building-Event-Driven-Apps-with-Fabric-Real-Time-Intelligence-and-SQL.html" | relative_url }})
- [Optimize Savings with Microsoft Fabric Reservations]({{ "/2025-10-30-Optimize-Savings-with-Microsoft-Fabric-Reservations.html" | relative_url }})
...
- [Optimize Azure Costs with Reserved VM Instances]({{ "/2025-10-28-Optimize-Azure-Costs-with-Reserved-VM-Instances.html" | relative_url }})
- [Understanding Shared Capacity Reservations in Azure]({{ "/2025-10-27-Understanding-Shared-Capacity-Reservations-in-Azure.html" | relative_url }})
...
- [Azure Update - 31st October 2025]({{ "/2025-10-31-Azure-Update-31st-October-2025.html" | relative_url }})
...
- [Changing User Source of Authority from AD to Entra ID]({{ "/2025-10-29-Changing-User-Source-of-Authority-from-AD-to-Entra-ID.html" | relative_url }})
...
- [.NET Libraries: Monetization Models and Open Source Challenges]({{ "/2025-10-28-NET-Libraries-Monetization-Models-and-Open-Source-Challenges.html" | relative_url }})
...
- [Getting Started with PowerToys Command Palette Extension Development]({{ "/2025-10-31-Getting-Started-with-PowerToys-Command-Palette-Extension-Development.html" | relative_url }})
...
- [Authentic DevOps with AI Foundry and GitHub: Enhancing Security Automation]({{ "/2025-10-31-Authentic-DevOps-with-AI-Foundry-and-GitHub-Enhancing-Security-Automation.html" | relative_url }})
...
- [VS Code Live: Highlights from GitHub Universe Announcements]({{ "/2025-10-27-VS-Code-Live-Highlights-from-GitHub-Universe-Announcements.html" | relative_url }})
