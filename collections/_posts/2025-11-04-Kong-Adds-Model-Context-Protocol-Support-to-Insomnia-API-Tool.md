...
permalink: "/posts/2025-11-04-Kong-Adds-Model-Context-Protocol-Support-to-Insomnia-API-Tool.html"
categories: ["AI", "DevOps"]
tags: ["AI", "AI APIs", "AI Security", "Anthropic", "API Debugging", "API Design", "API Management", "API Observability", "API Testing", "Automation", "Business Of DevOps", "Compliance", "DevOps", "Git Sync", "Insomnia", "Insomnia 12", "Insomnia MCP Support", "Kong Inc", "Large Language Models", "LLM Integration", "Marco Palladino", "MCP", "MCP Clients", "MCP Servers", "Mock Servers", "Open Source Tools", "Posts", "RBAC", "Role Based Access Control", "Social Facebook", "Social LinkedIn", "Social X", "Version Control"]
tags_normalized: ["ai", "ai apis", "ai security", "anthropic", "api debugging", "api design", "api management", "api observability", "api testing", "automation", "business of devops", "compliance", "devops", "git sync", "insomnia", "insomnia 12", "insomnia mcp support", "kong inc", "large language models", "llm integration", "marco palladino", "mcp", "mcp clients", "mcp servers", "mock servers", "open source tools", "posts", "rbac", "role based access control", "social facebook", "social linkedin", "social x", "version control"]
---
...
For additional details about MCP and Insomnia's AI/DevOps integrations, visit [Kong's announcement](https://devops.com/kong-adds-mcp-support-to-tool-for-designing-and-testing-apis/) or review the [official Insomnia documentation](https://insomnia.rest/).

This post appeared first on "DevOps Blog". [Read the entire article here](https://devops.com/kong-adds-mcp-support-to-tool-for-designing-and-testing-apis/)
