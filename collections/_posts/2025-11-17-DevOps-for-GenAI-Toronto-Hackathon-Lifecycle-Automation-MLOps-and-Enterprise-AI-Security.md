...
permalink: "/posts/2025-11-17-DevOps-for-GenAI-Toronto-Hackathon-Lifecycle-Automation-MLOps-and-Enterprise-AI-Security.html"
categories: ["AI", "DevOps", "ML", "Security"]
tags: ["Agent Deployment", "AI", "AI Observability", "AI Security", "Argo Workflows", "CI/CD Automation", "Community Collaboration", "Continuous Integration", "Contributed Content", "DevOps", "Enterprise AI Security", "Enterprise Governance", "Explainable AI", "GenAI", "Generative AI", "Grafana", "Hackathon", "Kubeflow", "Kubernetes", "ML", "MLflow", "MLOps", "OpenTelemetry", "Policy as Code", "Posts", "Prometheus", "Security", "Social Facebook", "Social LinkedIn", "Social X"]
tags_normalized: ["agent deployment", "ai", "ai observability", "ai security", "argo workflows", "cislashcd automation", "community collaboration", "continuous integration", "contributed content", "devops", "enterprise ai security", "enterprise governance", "explainable ai", "genai", "generative ai", "grafana", "hackathon", "kubeflow", "kubernetes", "ml", "mlflow", "mlops", "opentelemetry", "policy as code", "posts", "prometheus", "security", "social facebook", "social linkedin", "social x"]
---
...
- [Official GitHub Repository](https://github.com/CanadaDevOpsCommunity2025)
- [Eventbrite Registration](https://www.eventbrite.com/e/devops-for-genai-hackathon-tickets-1407877793379?aff=oddtdtcreator)

Join the hackathon and contribute to the future of trustworthy, ethical, and scalable GenAI platforms!

This post appeared first on "DevOps Blog". [Read the entire article here](https://devops.com/devops-for-genai-toronto-edition-hackathon-unlocking-new-ai-market-opportunities/)
