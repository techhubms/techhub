...
permalink: "/posts/2024-10-24-How-to-Run-SQL-Server-on-Windows-ARM-Devices-Solutions-and-Workarounds.html"
categories: ["Azure", "Coding"]
tags: [".NET", "ARM64", "Azure", "Azure Data Studio", "Azure SQL Edge", "Coding", "Database Development", "Docker", "Emulation", "LocalDb", "Named Pipes", "Posts", "SnapDragon X Elite", "SQL Server", "SQL Server Express", "VS", "Windows", "Windows 11", "Windows ARM"]
tags_normalized: ["dotnet", "arm64", "azure", "azure data studio", "azure sql edge", "coding", "database development", "docker", "emulation", "localdb", "named pipes", "posts", "snapdragon x elite", "sql server", "sql server express", "vs", "windows", "windows 11", "windows arm"]
---
