...
permalink: "/posts/2025-11-28-Automatically-Signing-Windows-Executables-with-Azure-Trusted-Signing-dotnet-sign-and-GitHub-Actions.html"
categories: ["Azure", "Coding", "DevOps", "Security"]
tags: [".NET", ".NET Sign", "Azure", "Azure CLI", "Azure Trusted Signing", "Certificate Profile", "CI/CD Pipeline", "Code Signing Certificate", "Coding", "DevOps", "Digital Signature", "DotNetCore", "GitHub Actions", "Identity Validation", "Posts", "Role Based Access Control", "Security", "Service Principal", "SmartScreen Reputation", "Windows Executable Signing", "YAML Workflow"]
