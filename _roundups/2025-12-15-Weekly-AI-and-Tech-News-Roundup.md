...
- [Exploring AI Models and GitHub Copilot's Raptor Mini in VS Code]({{ "/2025-12-08-Exploring-AI-Models-and-GitHub-Copilots-Raptor-Mini-in-VS-Code.html" | relative_url }})
...
- [Agent HQ for VS Code: Unified Agent Experience with GitHub Copilot]({{ "/2025-12-10-Agent-HQ-for-VS-Code-Unified-Agent-Experience-with-GitHub-Copilot.html" | relative_url }})
...
- [Rubber Duck Thursdays: Using GitHub Copilot Custom Agents to Address Tech Debt]({{ "/2025-12-09-Rubber-Duck-Thursdays-Using-GitHub-Copilot-Custom-Agents-to-Address-Tech-Debt.html" | relative_url }})
- [Ship Faster: End-to-End Azure App Development with GitHub Copilot and Intelligent Agents]({{ "/2025-12-10-Ship-Faster-End-to-End-Azure-App-Development-with-GitHub-Copilot-and-Intelligent-Agents.html" | relative_url }})
...
- [Modernizing Legacy Apps with GitHub Copilot and Azure]({{ "/2025-12-10-Modernizing-Legacy-Apps-with-GitHub-Copilot-and-Azure.html" | relative_url }})
...
- [Scripting the GitHub Copilot CLI - Deep Dive]({{ "/2025-12-11-Scripting-the-GitHub-Copilot-CLI-Deep-Dive.html" | relative_url }})
...
- [Plan, Specify, and Implement with Spec Kit and GitHub Copilot]({{ "/2025-12-11-Plan-Specify-and-Implement-with-Spec-Kit-and-GitHub-Copilot.html" | relative_url }})
- [Showcasing a Quantum Computing Educational Platform with Custom Copilot]({{ "/2025-12-12-Showcasing-a-Quantum-Computing-Educational-Platform-with-Custom-Copilot.html" | relative_url }})
...
- [Eirini Kalliamvakou Discusses Copilot and AI Trends in the 2025 Octoverse Report]({{ "/2025-12-12-Eirini-Kalliamvakou-Discusses-Copilot-and-AI-Trends-in-the-2025-Octoverse-Report.html" | relative_url }})
...
- [How I shipped more code and products than ever before with GitHub Copilot]({{ "/2025-12-11-How-I-shipped-more-code-and-products-than-ever-before-with-GitHub-Copilot.html" | relative_url }})
- [Building AI Agents with VS Code, GitHub Copilot, and Azure]({{ "/2025-12-10-Building-AI-Agents-with-VS-Code-GitHub-Copilot-and-Azure.html" | relative_url }})
...
- [Nasdaq Boardvantage: AI-Driven Governance Architecture with Azure PostgreSQL and Microsoft Foundry]({{ "/2025-12-09-Nasdaq-Boardvantage-AI-Driven-Governance-Architecture-with-Azure-PostgreSQL-and-Microsoft-Foundry.html" | relative_url }})
...
- [Ignite BRK197: AI Powered Automation & Multi-Agent Orchestration in Foundry]({{ "/2025-12-10-Ignite-BRK197-AI-Powered-Automation-and-Multi-Agent-Orchestration-in-Foundry.html" | relative_url }})
- [Build a Pizza Ordering Agent with Microsoft Foundry and MCP]({{ "/2025-12-10-Build-a-Pizza-Ordering-Agent-with-Microsoft-Foundry-and-MCP.html" | relative_url }})
...
- [Ignite BRK1706: Build and Manage AI Apps with Microsoft Foundry]({{ "/2025-12-10-Ignite-BRK1706-Build-and-Manage-AI-Apps-with-Microsoft-Foundry.html" | relative_url }})
...
- [Unlock agentic workflows for your apps using MCP on Windows]({{ "/2025-12-10-Unlock-agentic-workflows-for-your-apps-using-MCP-on-Windows.html" | relative_url }})
- [Model Context Protocol: From Concept to Linux Foundation Agentic AI]({{ "/2025-12-09-Model-Context-Protocol-From-Concept-to-Linux-Foundation-Agentic-AI.html" | relative_url }})
...
- [Supercharge Your Apps with OpenAI: Secure Authentication, Azure Integration, and MCP Agents]({{ "/2025-12-10-Supercharge-Your-Apps-with-OpenAI-Secure-Authentication-Azure-Integration-and-MCP-Agents.html" | relative_url }})
- [Secure and Smart AI Agents with Azure Redis in .NET]({{ "/2025-12-10-Secure-and-Smart-AI-Agents-with-Azure-Redis-in-NET.html" | relative_url }})
- [Modernization Made Simple: Building Agentic Solutions in .NET]({{ "/2025-12-10-Modernization-Made-Simple-Building-Agentic-Solutions-in-NET.html" | relative_url }})
- [Bulletproof Agents with the Durable Task Extension for Microsoft Agent Framework]({{ "/2025-12-10-Bulletproof-Agents-with-the-Durable-Task-Extension-for-Microsoft-Agent-Framework.html" | relative_url }})
...
- [AI-Driven Product Change Management with Copilot Studio for Manufacturing]({{ "/2025-12-09-AI-Driven-Product-Change-Management-with-Copilot-Studio-for-Manufacturing.html" | relative_url }})
...
- [Aspire for AI Applications]({{ "/2025-12-10-Aspire-for-AI-Applications.html" | relative_url }})
...
- [The Human Side of Octoverse 2025: Insights on Open Source, AI, and Collaboration]({{ "/2025-12-08-The-Human-Side-of-Octoverse-2025-Insights-on-Open-Source-AI-and-Collaboration.html" | relative_url }})
...
- [What's New and Generally Available in SQL Database in Microsoft Fabric]({{ "/2025-12-11-Whats-New-and-Generally-Available-in-SQL-Database-in-Microsoft-Fabric.html" | relative_url }})
...
- [Proactive .NET Reliability with Azure SRE Agent]({{ "/2025-12-10-Proactive-NET-Reliability-with-Azure-SRE-Agent.html" | relative_url }})
...
- [Using Logic Apps as Model Context Protocol (MCP) Servers for AI Applications]({{ "/2025-12-09-Using-Logic-Apps-as-Model-Context-Protocol-MCP-Servers-for-AI-Applications.html" | relative_url }})
...
- [No-code Modernization for ASP.NET with Managed Instance on Azure App Service]({{ "/2025-12-10-No-code-Modernization-for-ASPNET-with-Managed-Instance-on-Azure-App-Service.html" | relative_url }})
...
- [Azure Update - 12th December 2025]({{ "/2025-12-12-Azure-Update-12th-December-2025.html" | relative_url }})
...
- [Agentic DevOps: Enhancing .NET Web Apps with Azure MCP]({{ "/2025-12-10-Agentic-DevOps-Enhancing-NET-Web-Apps-with-Azure-MCP.html" | relative_url }})
- [A Unified Agent Experience in Visual Studio Code]({{ "/2025-12-12-A-Unified-Agent-Experience-in-Visual-Studio-Code.html" | relative_url }})
...
- [Securely Unleashing AI Agents on Azure SQL and SQL Server]({{ "/2025-12-10-Securely-Unleashing-AI-Agents-on-Azure-SQL-and-SQL-Server.html" | relative_url }})
...
- [The Role of Storytelling in Security Modeling]({{ "/2025-12-12-The-Role-of-Storytelling-in-Security-Modeling.html" | relative_url }})
