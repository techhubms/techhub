...
- [GitHub Copilot in JetBrains: Demo of MCP and Agent Mode]({{ "/2025-11-04-GitHub-Copilot-in-JetBrains-Demo-of-MCP-and-Agent-Mode.html" | relative_url }})
...
- [Behind the Scenes of VS Code’s Planning Agent]({{ "/2025-11-03-Behind-the-Scenes-of-VS-Codes-Planning-Agent.html" | relative_url }})
...
- [Modernize Java Apps with AI: Deploy Your Applications to Azure]({{ "/2025-11-03-Modernize-Java-Apps-with-AI-Deploy-Your-Applications-to-Azure.html" | relative_url }})
- [Building Scalable AI Apps and Agents with VS Code, GitHub Copilot, and Agent Framework]({{ "/2025-11-05-Building-Scalable-AI-Apps-and-Agents-with-VS-Code-GitHub-Copilot-and-Agent-Framework.html" | relative_url }})
...
- [Scaling Generative AI with GPU-Powered Containers on Azure]({{ "/2025-11-05-Scaling-Generative-AI-with-GPU-Powered-Containers-on-Azure.html" | relative_url }})
- [Running GenAI in Containers: Dynamic Sessions with Azure Container Apps and LangChain4j]({{ "/2025-11-05-Running-GenAI-in-Containers-Dynamic-Sessions-with-Azure-Container-Apps-and-LangChain4j.html" | relative_url }})
- [Java and AI for Beginners: Full Series on Building and Modernizing AI-Powered Java Apps]({{ "/2025-11-07-Java-and-AI-for-Beginners-Full-Series-on-Building-and-Modernizing-AI-Powered-Java-Apps.html" | relative_url }})
...
- [Building Multi-Agent AI Systems with LangChain4j and Java]({{ "/2025-11-04-Building-Multi-Agent-AI-Systems-with-LangChain4j-and-Java.html" | relative_url }})
- [Armchair Architects: Defining AI Agents and Their Core Traits]({{ "/2025-11-04-Armchair-Architects-Defining-AI-Agents-and-Their-Core-Traits.html" | relative_url }})
- [Beyond Chat: Building Smarter AI Agents in .NET with AiGen]({{ "/2025-11-05-Beyond-Chat-Building-Smarter-AI-Agents-in-NET-with-AiGen.html" | relative_url }})
...
- [Building Intelligent AI Applications with Java, Spring Boot, and LangChain4j]({{ "/2025-11-04-Building-Intelligent-AI-Applications-with-Java-Spring-Boot-and-LangChain4j.html" | relative_url }})
...
- [From Building to Fine-Tuning: Coding Agents that Optimize AI Workflows]({{ "/2025-11-04-From-Building-to-Fine-Tuning-Coding-Agents-that-Optimize-AI-Workflows.html" | relative_url }})
...
- [Azure Weekly Update: November 7, 2025]({{ "/2025-11-07-Azure-Weekly-Update-November-7-2025.html" | relative_url }})
...
- [.NET Data Community Standup: EF 10 Release Celebration]({{ "/2025-11-06-NET-Data-Community-Standup-EF-10-Release-Celebration.html" | relative_url }})
- [.NET MAUI Community Standup: 10 Years of Grial]({{ "/2025-11-05-NET-MAUI-Community-Standup-10-Years-of-Grial.html" | relative_url }})
...
- [Anders Hejlsberg on Octoverse 2025: TypeScript Evolution, Go, and AI in Development]({{ "/2025-11-06-Anders-Hejlsberg-on-Octoverse-2025-TypeScript-Evolution-Go-and-AI-in-Development.html" | relative_url }})
...
- [The Download: Highlights from GitHub Universe 2025, Octoverse, and Game Off]({{ "/2025-11-07-The-Download-Highlights-from-GitHub-Universe-2025-Octoverse-and-Game-Off.html" | relative_url }})
...
- [Secure by Design: Upcoming CMK and Auditing Features in Fabric SQL Database]({{ "/2025-11-05-Secure-by-Design-Upcoming-CMK-and-Auditing-Features-in-Fabric-SQL-Database.html" | relative_url }})
